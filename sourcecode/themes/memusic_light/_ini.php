...
// header js
$loader->theme->set_name('__default')->loader->html->add_java( 'translations', 'assets/js/texts.js?lang=' . $loader->ui->lang );
...
$loader->theme->set_name('__default')->loader->html->add_java( 'custom_be_cli','assets/js/be_cli.min.js?v='.$v, true );
$loader->theme->set_name('__default')->loader->html->add_java( 'custom_pager', 'assets/js/pager.min.js?v='.$v, true );
$loader->theme->set_name('__default')->loader->html->add_java( 'custom_app',   'assets/js/app.min.js?v='.$v, true );
$loader->theme->set_name('__default')->loader->html->add_java( 'custom_muse',  'assets/js/muse.min.js?v='.$v, true );
$loader->theme->set_name()->loader->html->add_java( 'custom_app2', 'assets/js/app.min.js?v='.$v, true );
