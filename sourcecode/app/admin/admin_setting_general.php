...
<form method="post" class="be_cli_form" data-action="admin_save_setting_general" data-target=".watermark">
  ...
  <div class="row">
  	<div class="col-6">
  	  ...
  	  <div class="tip">1 button, unlimited related tracks. If you have Spotify API enabled and you allow stations, there will be a `station` button which looks like an anthena next to good old play/pause button. Once clicked, MeMusic will play that item ( track/album/artist/widget ) and set that item as station `seed`. Then it will find relative tracks for those seeds and add them to `Up Next`</div>
  	</div>
