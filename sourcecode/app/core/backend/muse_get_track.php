...
if ( !empty( $track_data["source"] ) ? $track_data["source"]["type"] == "youtube" && $loader->admin->get_setting( "youtube_dl", 0, [0,1] ) && $loader->admin->get_setting( "ffmpeg", 0, [0,1] ) : false ){
